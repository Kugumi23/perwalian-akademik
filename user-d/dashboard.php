...
<head>
    ...
    <title>BSPAM Online : Dashboard</title>
...
<body>
    ...
    <div class="offcanvas offcanvas-start" id="canvas">
        ...
        <div class="offcanvas-body sides">
            <a href="dashboard.php" class="nav-link active pt-3 pb-3 text-light activated">Dashboard</a>
            <a href="data_mahasiswa.php" class="nav-link pt-3 pb-3">Data Mahasiswa</a>
            <a href="data_konsultasi.php" class="nav-link active pt-3">Data Konsultasi</a>
